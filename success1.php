...
<a href="http://www.akgec.in/" target="_blank"><img style="float: left;" src="images/akgeclogo.png"></a>
  ...
  <a href="logout.php" title="HOME" ><img class='imgpop' style="float: right;" src="images/home2.png"></a>
...
<div id="myModal" class="modal">
  ...
  <div class="modal-content">
    <div class="modal-header">
      ...
      <!-- change here -->
      <a href="logout.php"><button style="float: center;" type="back" class="button3" >Go Back</button></a>
