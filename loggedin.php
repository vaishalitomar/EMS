...
<div id="myModal" class="modal">
  ...
  <div class="modal-content">
    <div class="modal-header">
      ...
      <h1 style="font-color:red; text-align: center; font-size:25px">Already Logged In</h1>
      <!-- change here -->
      <a href="index2.php"><button style="float: center;" type="back" class="button3" >Log out</button></a>
